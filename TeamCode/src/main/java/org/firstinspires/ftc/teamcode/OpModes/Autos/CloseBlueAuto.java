...
public class BlueAuto extends OpMode {
    ...
    private static final double TICKS_PER_REV = 28.0; //28*(40.0/31)
    ...
    private final Pose turnToIntake = new Pose(58.63551401869158, 92, Math.toRadians(180));
    private final Pose intake1 = new Pose(22, 92, Math.toRadians(180));
    private final Pose releaseBalls = new Pose(18.8411214953271, 81, Math.toRadians(180));
    ...
    public class Paths {
        ...
        private PathChain startToEnd, endToTurnToIntake, turnToIntakeToIntake1, intake1ToReleaseBalls, releaseBallsToEndPose, endPoseToIntake2, endPoseToLineUp, lineupToIntake2, intake2ToEndPose, endPoseToLineup3, lineup3ToIntake3, intake3ToEndPose;
        Follower follow;
